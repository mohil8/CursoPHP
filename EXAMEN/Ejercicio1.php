...
<body>
    <form action="#" method="POST">
        ...
        <input type="text" id="peli" name="titulo">
        <br>
        ...
        <br>
        <label>Tipo</label><br>
        <input type="radio" name="tipo" id="idPeli" value="Pelicula" checked> 
        <label for="idPeli">Pelicula</label>
        <input type="radio" name="tipo" id="idSerie" value="Serie">
        <label for="idSerie">Serie</label>
        <br>
        <label for="idCap">Nº Capítulos</label><br>
        <input type="number" name="numero" id="idCap" >
        <br><br>
